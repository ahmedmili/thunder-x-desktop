...
var Slider3 = React71.forwardRef(function Slider4(inputProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime49.jsx)(RailSlot, _extends({}, railProps)), (0, import_jsx_runtime49.jsx)(TrackSlot, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      const percent = valueToPercent(mark.value, min2, max2);
      const style = axisProps2[axis].offset(percent);
      let markActive;
      if (track === false) {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OQT3AKQN.js.map
