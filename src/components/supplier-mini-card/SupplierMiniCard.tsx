...
import supplierStyle from './SupplierMiniCard.module.scss';

interface SupplierMiniCard {
    data: Restaurant,
    favors?: boolean,
    className?: string
}

const SupplierMiniCard: React.FC<SupplierMiniCard> = ({ data, favors = false, className }) => {
    ...
    return (
        <div className={`${supplierStyle.SupplierMiniCard} ${className}`}>
            {/* favors icons */}
            {/* {(fav) ? (
...
export default SupplierMiniCard